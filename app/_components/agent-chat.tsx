      ...
      >
        {showConversationLayout ? null : (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="max-w-md text-balance text-muted-foreground text-base">
              Long-term memory for your AI agent, powered by Mem0. Tell it something about
              yourself, start a new chat, and it still remembers.
            </p>
          </div>
        )}
